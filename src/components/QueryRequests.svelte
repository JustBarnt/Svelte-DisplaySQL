<script>
	...
	const query = { amount: 10, name: "createdby", value: "joshr", startDate: "2013-07-26", endDate: "2013-07-26" };
...
<div id="container">
	<form  method="GET" class="get-form" on:submit|preventDefault={() => QueryRequest(defaultQueryType)}>
		...
		<span>
			Created between<br>
			<input type="date" id="startDate" name="StartDate" bind:value={query.startDate}>
			<input type="date" id="endDate" name="EndDate" bind:value={query.endDate}>
		</span>
		<br>
